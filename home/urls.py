...
#   Philippe: what is this ???
	...
	path('verovio/<str:source_id>', views.verovio, name='show_with_verovio'),
	...
	# Opus views
	path('opus/<str:opus_ref>/iiif_manifest.json', views.iiif_manifest , name='iiif_manifest'),
	path('opus/<str:opus_ref>/_edit/', views.edit_opus , name='edit_opus'),
	path('opus/<str:opus_ref>/_source/<str:source_ref>', SourceView.as_view(template_name="home/source.html"), name='source'),
	path('opus/<str:opus_ref>/', OpusView.as_view(template_name="home/opus.html"), name='opus'),
