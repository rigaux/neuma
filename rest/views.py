...
def annotation_to_rest(annotation):
    ...
    if annotation.offset == "":
        annotation.offset = annotation.ref

    return {
        "id": annotation.id,
        "username": annotation.user.username,
        "full_user_name": annotation.user.first_name + " " + annotation.user.last_name,
        "model_ref": annotation.model_ref,
        "concept": annotation.analytic_concept.code,
        "offset": annotation.offset,
        "m21_offset": annotation.m21_offset,
        "comment": annotation.comment,
        "xml_fragment": annotation.xml_fragment,
        "created_at": annotation.created_at.strftime("%d/%d/%Y"),
        "updated_at": annotation.updated_at.strftime("%d/%d/%Y"),
        "is_manual": annotation.is_manual,
        "display_options": annotation.analytic_concept.display_options,
        "icon": annotation.analytic_concept.icon,
    }
